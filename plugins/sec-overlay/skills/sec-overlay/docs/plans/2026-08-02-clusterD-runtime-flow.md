...
**Files:** Modify `helpers/sec_overlay/models.py` (add field). Test: `helpers/tests/test_models.py`.
...
- [ ] **Step 6: commit** — `git add skills/sec-overlay/helpers/sec_overlay/models.py skills/sec-overlay/helpers/tests/test_models.py && git commit -m "feat(models): runtime_dependent marker for runtime-only findings (O-010)"`

---

### Task 2: campaign.promote_runtime_dependent

**Files:** Modify `helpers/sec_overlay/campaign.py` (add function). Test: `helpers/tests/test_campaign.py`.
...
**Files:** Modify `skills/sec-overlay/agents/investigate.md`, `skills/sec-overlay/agents/validate.md`, `skills/sec-overlay/SKILL.md`. No test (prose).
...
- [ ] **Step 3: SKILL.md** — in Phase 5.5 (Red Team), before the red-team agent step, add: "First run `promote_runtime_dependent(ws)` (from `sec_overlay.campaign`) so raw findings marked `runtime_dependent` become `needs-deployment-testing` and enter the plan (O-021)."
- [ ] **Step 4: commit** — `git add skills/sec-overlay/agents/investigate.md skills/sec-overlay/agents/validate.md skills/sec-overlay/SKILL.md && git commit -m "docs(sec-overlay): agents set runtime_dependent; SKILL promotes it pre-redteam (O-021)"`
