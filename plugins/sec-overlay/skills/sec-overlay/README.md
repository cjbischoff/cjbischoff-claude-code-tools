...
| To understand… | Read |
|----------------|------|
| The full phase-by-phase operating playbook, and the diff-scoped `review` mode (`--profile security\|general`, REV-01), including its retract-only reflection pass (D-16) | [`SKILL.md`](SKILL.md) |
