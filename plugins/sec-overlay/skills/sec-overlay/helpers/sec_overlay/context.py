...
_SKIP = ("node_modules", "vendor", ".git", "dist", "build", ".sec-overlay")
_MAX_FILES = 200
...
def control_findings(ctx: Context, discovery_sha: str | None = None) -> list:
    ...
    Returns:
        A list of :class:`sec_overlay.models.Finding` in CANDIDATE status, id ``CTL-####``.
    """
...
def manual_review_findings(ctx: Context, discovery_sha: str | None = None) -> list:
    ...
    Returns:
        A list of :class:`sec_overlay.models.Finding` in NEEDS_DEPLOYMENT_TESTING
        status, id ``LEAD-####``.
    """
    from sec_overlay.models import Finding, FindingStatus, Severity
