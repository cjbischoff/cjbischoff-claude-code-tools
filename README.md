...
- Doc fix: synced `references/README.md`'s `finding.schema.json` row with the `open_questions` field, and corrected the skill `CLAUDE.md` §6 block count/list from six to the actual twelve `prompt-constants.md` blocks.
